...
<html lang="en">
  <head>
    ...
    <title>Sistema POS - Usuario</title>
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <p class="card-text"><small class="text-muted">
          <a href="<?=base_url('menu_compras')?>" class="btn btn-primary"><i class="fa fa-tags"></i> Ingreso</a></small></p>
      </div>
    </div>
  </div>
</div> </td>
...
<tr> <td><div class="card text-bg-secondary mb-3 mb-3" style="max-width: 540px;">
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Salir del Sistema</h5>
